...
// This is the event for enemy aggro I assume
...
//Multiplayer Barrier Event scripts (DO NOT TOUCH)
...
//End of Multiplayer Barrier Event Scripts
L1:
    if (NumberOfClientsOfType(ClientType.Invader) != 0) {
        DisplayEpitaphMessage(X8_4);
    }
...
$Event(20005625, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X24_4, X28_4, X32_4, X36_4, X40_4, X44_4) {
    if (!(((EventFlag(X0_4) && EventFlag(X4_4)) || (!EventFlag(X0_4) && !EventFlag(X4_4)))
        ...
        if (!EventFlag(X4_4)) {
            ...
            WaitFor(obj || flag || areaSpFlag);
            if (NumberOfClientsOfType(ClientType.Invader) != 0) {
                //This is disabling something ... but what? Bonfires perhaps?
                SetObjactState(X20_4, -1, Disabled);
            }
            if (NumberOfClientsOfType(ClientType.Invader) != 0) {
                SetNetworkconnectedEventFlag(X36_4, ON);
...
$Event(20000627, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4) {
    ...
    if (X8_4 != 0) {
        ...
        WaitFor(flagAct);
        //Display text box saying "Contraption does not move"
...
$Event(20005628, Restart, function(X0_4, X4_4, X8_4) {
    ...
    //Is the player near the lever? Also is the player either embered(Alive) or not ember(Hollow)
    ...
    if (!areaChr.Passed) {
        EndIf(EventFlag(X0_4));
        //Render the text box saying "Contraption does not move" If the above event ends
        DisplayGenericDialog(10010170, PromptType.OKCANCEL, NumberofOptions.OneButton, -1, 3);
        RestartEvent();
    }
L0:
...
$Event(20005700, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4) {
    ...
    PlaceNPCSummonSignWorksForNonemberedPlayers(SummonSignType.WhiteSign, X12_4, X16_4, X4_4, X8_4)
...
$Event(20005750, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X24_4, X28_4, X32_4) {
    ...
    && !EventFlag(X8_4)
        ...
        WaitFixedTimeSeconds(X28_4);
    PlaceNPCSummonSignWorksForNonemberedPlayers(SummonSignType.BlackSign, X12_4, X16_4, X4_4, X8_4)
    PlaceNPCSummonSign(SummonSignType.BlackSign,X12_4, X16_4, X4_4, X8_4);
    //WaitFixedTimeSeconds(1);
    RestartEvent();
});
...
$Event(20005752, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X24_4, X28_4, X32_4, X36_4, X40_4, X44_4) {
    ...
    WaitFixedTimeSeconds(X28_4);
    PlaceNPCSummonSignWorksForNonemberedPlayers(SummonSignType.BlackSign, X12_4, X16_4, X4_4, X8_4); //Investigate this
    //WaitFixedTimeSeconds(1);
    RestartEvent();
});
...
//Multiplayer Barrier scripts (DO NOT TOUCH)
...
//End of Multiplayer Barrier Scripts
...
L3:
    ...
    RestartIf(time.Passed);
L1:
//If the player is in their own world send a notification to any clients stating they can now challenge the boss.
//I'm removing this because if the players decide to tackle Iudex Gundyr this message box will not go away
    if (!PlayerIsNotInOwnWorld()) {
...
//Judging on the fact that theres a SendAllPhantomsHome function in here I think its safe to say this is for invaders and bosses
...
//I believe this is also apart of the multiplayer barriers scripts
...
// This is the event for using the Black Eye Orb
...
$Event(20006007, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4) {
    ...
    //EndIf(PlayerIsNotInOwnWorld());
    WaitFor(EventFlag(X4_4));
    //This is rotating the player for something...
...
//This may be the visual indicator for items like estus shards. We maaaay have to uncomment this
